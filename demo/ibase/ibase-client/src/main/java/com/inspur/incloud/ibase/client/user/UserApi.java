...
public interface UserApi {
	...
	OperationResult<UserApiModel> queryUserById(@RequestParam(name = "id", required = true) String id);
    ...
    OperationResult<PageListBean<UserApiModel>> listUsers(String name, Integer pageSize, Integer currentPage);
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "user4Create", paramType = "body", required = true, dataType = "User4Create", value = "用户信息")
	})
	@RequestMapping(value = "/action/add", method = RequestMethod.POST)
	OperationResult<UserApiModel> add(User4Create user4Create);
	...
	OperationResult<UserApiModel> delete(String userId);
	...
	@ApiImplicitParams({
		@ApiImplicitParam(name = "user4Create", paramType = "body", required = true, dataType = "User4Create", value = "更新的用户信息"),
		@ApiImplicitParam(name = "userId", paramType = "path", required = true, dataType = "String", value = "用户ID")
	})
	@RequestMapping(value = "{userId}/action/update", method = RequestMethod.PUT)
	OperationResult<UserApiModel> update(User4Create user4Create, String userId);
}
